	...
	public ActionForward execute(
		...
		String password = (String)session1.getAttribute("password");
		 ...
		 final URL url1 = new URL(ur);
	        ...
	        List<PhoneVO> phoneDetail = deatail.getPhoneListData().getPhones();
	  
	        session.setAttribute("phoneDetail", phoneDetail, PortletSession.APPLICATION_SCOPE);
		...
		return actionMapping.findForward("portlet.sample_struts_portlet.phones");
	}
