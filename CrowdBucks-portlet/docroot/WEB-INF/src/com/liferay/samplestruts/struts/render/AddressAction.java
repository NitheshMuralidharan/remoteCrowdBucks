...
public class AddressAction extends Action  {
	...
	public ActionForward execute(
		...
		String password = (String)session1.getAttribute("password");
		 ...
		 String ur = "http://localhost:6549/UserProfileAddress?user="+username+"&pass="+password;
		 // mule code
		 ...
		 final URL url1 = new URL(ur);
	        ...
	        list = (List<UserAddressVO>) obj;
	       
	        session.setAttribute("userAdd", list, PortletSession.APPLICATION_SCOPE);
			
	        System.out.println("page_count ="+list.size());
	        System.out.println("total_users ="+list.get(0).getAddressLine1());
		...
		return actionMapping.findForward("portlet.sample_struts_portlet.addresses");
	}
