...
public class Paypal extends BasePaymentModule implements PaymentInterface
{
    ...
    private static final String hostPortSubstitute = "localhost:8080";

    // Configuration Keys

    private final static String MODULE_PAYMENT_PAYPAL_STATUS = "true";

    private final static String MODULE_PAYMENT_PAYPAL_ID = "ravidubey001-facilitator@gmail.com";

    private final static String MODULE_PAYMENT_PAYPAL_ZONE = "none";

    private final static String MODULE_PAYMENT_PAYPAL_ORDER_STATUS_ID = "MODULE_PAYMENT_PAYPAL_ID";

    private final static String MODULE_PAYMENT_PAYPAL_SORT_ORDER = "0";

    /**
     * Username and password used to log into the engine by the IPN call from PayPal
     */
    private final static String MODULE_PAYMENT_PAYPAL_CALLBACK_USERNAME = "admin@konakart.com";

    private final static String MODULE_PAYMENT_PAYPAL_CALLBACK_PASSWORD = "princess";
     ...
     */
    private final static String MODULE_PAYMENT_PAYPAL_CALLBACK_URL = "http://localhost:8080/konakart/PayPalCallback.action";
     ...
     */
    private final static String MODULE_PAYMENT_PAYPAL_RETURN_URL = "http://localhost:8080/konakart/CheckoutFinished.action";
     ...
     * host:port is substituted automatically with the correct value.
     */
    private final static String MODULE_PAYMENT_PAYPAL_CANCEL_URL = "http://localhost:8080/konakart/CatalogCheckoutExternalPaymentErrorPage.action";

    /**
     * If set to true, the module will use the PayPal sandbox. Otherwise the live URL will be used.
     */
    private final static String MODULE_PAYMENT_PAYPAL_TEST_MODE = "true";
