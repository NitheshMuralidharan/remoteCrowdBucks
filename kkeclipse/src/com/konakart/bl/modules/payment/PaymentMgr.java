...
public class PaymentMgr extends BaseMgr implements PaymentMgrIf
{
            ...
            String hostAndPort, int languageId) throws Exception
    {
    	...
    	System.out.println("It is entering into paymentDetails");    
        checkRequired(sessionId, "String", "sessionId");
        checkRequired(moduleCode, "String", "moduleCode");
        //checkRequired(hostAndPort, "String", "hostAndPort");
        System.out.println("locahost is set!!!!!!!!!!!!!!! but still error");
     /*if (hostAndPort == null || hostAndPort.length() == 0) {
            hostAndPort = "localhost:8780";
        }*/
        System.out.println( "checking hostAndPort"+hostAndPort);
        // Get the order
            ...
            OrderIf order, String hostAndPort, int languageId) throws Exception
    {
        ...
        info.setHostAndPort("localhost:8080");
